    ...
    const privacyContent = [
      {
        ...
        content: (
          <a href="uzrindia.com" className="text-blue-600 underline ml-1">
           uzrindia.com
          </a>
        )
      },
      {
        ...
        content: "At UZR, we are committed to protecting your privacy and information.",
      },
      {
        title: "WEBSITE PRIVACY POLICY STATEMENT",
        content:
          "It is the policy of UZR to act in accordance with current legislation and to meet the best practices on the Internet. Our aim is to be responsible, relevant, and secure when using your data.",
      },
      {
      ...
      },
      {
        title: "DATA USAGE",
        content:
          "We collect data for the following purposes: technical administration of the website, enhancing your experience of the site, customer service, and UZR promotion. If we wish to use your personal data for any new purposes, we will ask for your consent in advance.",
      },
      {
        title: "DATA SHARING",
        content:
      ...
      },
      {
        title: "DATA SECURITY",
        content:
          "Unfortunately, no data transmission over the Internet is 100% secure. While we try to protect your personal information, UZR cannot guarantee the security of any information you transmit to us, and you do so at your own risk.",
      },
      {
          ...
          <div className="space-y-6 text-gray-700">
            {privacyContent.map((section, index) => (
              <div key={index} className="space-y-4">
                <h2 className="text-xl font-semibold mt-8 mb-2 uppercase">{section.title}</h2>
