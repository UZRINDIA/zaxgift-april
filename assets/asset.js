...
export const BagIcon = () => {
  ...
  export const productsDummyData = [
    ...
    },
    {
      ...
      "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
      "name": "Blue Cap",
      "description": "The Blue Cap is a stylish and versatile accessory designed for everyday comfort. Crafted from premium breathable cotton, it keeps you cool and protected under the sun. Its adjustable strap ensures a perfect fit for all head sizes, while the curved brim adds a classic sporty touch. Whether you’re heading out for a run, a casual outing, or just completing your streetwear look, this blue cap adds effortless style to any outfit.",
      "price": 429.99,
      "offerPrice": 329.99,
      "image": [
        bluecap
